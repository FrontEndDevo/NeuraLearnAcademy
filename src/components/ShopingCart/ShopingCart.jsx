    ...
    <>
      ...
      <div className="flex flex-col md:flex-row mx-4 mb-10">
        <div className="ml-0 md:ml-10 xl:ml-32 mt-20 w-full md:w-7/12">
          ...
          {ShopingCartCourses.slice(
            ...
            return (
              <div
                key={item}
                className="mb-2 relative flex pl-[1.rem] pr-5 pt-4 pb-3 bg-white rounded-[0.3rem] border-b border-black border-opacity-60 transform hover:scale-105  transition-transform duration-500"
              >
                <div>
                  <img
                    src={item.image}
                ...
                <div className="ml-5">
                  <div className="flex ">
                    <Link className="text-blue-900 text-sm font-semibold underline tracking-tight  xl:text-lg">
                      {item.title}
                    </Link>
                  ...
                  <div className="flex my-1">
                    ...
                    <button className=" absolute right-1 text-blue-700 text-base font-semibold tracking-tight hover:text-blue-900">
        ...
        <div className="order-first md:order-none w-full md:w-[316px] h-[214px] pt-4 pl-7 ml-0 md:ml-20 2xl:ml-40 my-5  md:mt-16 bg-white rounded-[1.5rem] shadow-xl flex flex-col justify-center">
          ...
          <button className="w-[150px] mx-auto bg-blue-700 rounded-[25px] p-2 my-2 text-white">
            Checkout
          </button>
        </div>
      </div>
