...
const CreateNewCourse = () => {
  ...
  return (
    <>
      ...
      <div className="lg:w-[80vw] w-[95vw] h-[90vh] lg:h-[85vh] overflow-y-scroll lg:overflow-y-hidden z-50 bg-white rounded-lg fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-xl">
