      ...
      <div className=" bg-white h-screen flex justify-around pt-10">
        ...
        <div className="flex flex-col md:flex-row md:space-x-3 lg:space-x-3">
          <div className="text-xl mb-4 md:mb-0 md:w-1/2 lg:w-auto">
            <button className="bg-white rounded-[10px] shadow px-5 py-5 flex flex-col justify-center items-center opacity-90 text-[#004682] font-bold tracking-wide cursor-pointer">
              <img
                src={plus}
