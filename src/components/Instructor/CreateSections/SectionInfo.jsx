        ...
        <div className="px-2 md:px-4 py-4 md:mx-10 ">
          ...
          <h2 className="text-black text-base font-semibold mt-12 mb-6">
            Select your type content :
                  ...
                  <div className="flex flex-col justify-center space-y-3 md:flex-row md:space-y-0 md:space-x-3 lg:space-x-6">
                      <div className="w-full md:w-auto">
                          <button style={{  boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.25)' }} className="bg-white rounded-[10px]   px-3 py-3 md:px-7 flex flex-col justify-center items-center opacity-90 text-[#004682] font-bold cursor-pointer w-full">
                              <img src={addVideo} className="w-8 py-1.5" alt="plus image" loading="lazy" />
                              <span className="">Video</span>
                          </button>
                      </div>
                      <div className="w-full md:w-auto">
                          <button style={{ boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.25)' }} className="bg-white rounded-[10px] shadow  px-3 py-3 md:px-7 flex flex-col justify-center items-center opacity-90 text-[#004682] font-bold cursor-pointer w-full">
                              <img src={addPhoto} className="w-8 py-1.5" alt="plus image" loading="lazy" />
                              <span className="">Photo</span>
                          </button>
                      </div>
                      <div className="w-full md:w-auto">
                          <button style={{ boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.25)' }} className="bg-white rounded-[10px] shadow  px-3 py-3 md:px-7 flex flex-col justify-center items-center opacity-90 text-[#004682] font-bold cursor-pointer w-full">
                              <img src={addText} className="w-8 py-1.5" alt="plus image" loading="lazy" />
                              <span className="">Text</span>
                          </button>
                      </div>
                      <div className="w-full md:w-auto">
                          <button style={{ boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.25)' }}  className="bg-white rounded-[10px] shadow  px-3 py-3 md:px-7 flex flex-col justify-center items-center opacity-90 text-[#004682] font-bold cursor-pointer w-full">
                              <img src={addFile} className="w-8 py-1.5" alt="plus image" loading="lazy" />
