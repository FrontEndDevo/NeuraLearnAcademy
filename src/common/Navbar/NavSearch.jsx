  ...
  return (
    <div className="relative flex items-stretch w-full">
      ...
      <input
        ...
        className="w-full px-1 md:px-4 md:pl-8 font-semibold py-3 text-xs outline-none tracking-wide rounded-[3px] rounded-r-none border border-neutral-800 text-neutral-800 caret-neutral-800"
      />
